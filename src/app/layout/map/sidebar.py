                ...
                children=[
                    ...
                    html.Button(
                        ...
                        style={
                            ...
                            'transition': 'all 0.15s',
                            'white-space': 'nowrap',
                            'border': '1px solid #e65100' if is_flagged else '1px solid #eee',
                            'background': '#fff3e0' if is_flagged else '#f5f5f5',
                            'color': '#e65100' if is_flagged else '#bdbdbd',
                            'font-weight': 'bold' if is_flagged else 'normal',
                            'opacity': '1' if author else '0.5',
                        },
                    ),
                ],
